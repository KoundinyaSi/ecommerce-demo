...
const OtpAuth: React.FC<OtpAuthProps> = ({ onOtpSuccess }) => {
  ...
  const handleVerify = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (enteredOtp === expectedOtp) {
      ...
      setOtpSuccess(otpSuccess => !otpSuccess);
  ...
  return (
    <div className="align-center justify-center place-self-center px-2 py-3">
      <form
        ...
        className="align-center flex w-full flex-col justify-center self-center"
      >
